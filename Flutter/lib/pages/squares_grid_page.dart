...
class SquaresGridPage extends StatefulWidget {
  const SquaresGridPage({super.key, required this.timers, required this.start});
  final List<TimerModel> timers;
  final DateTime start;

  @override
  State<SquaresGridPage> createState() => _SquaresGridPageState();
}

class _SquaresGridPageState extends State<SquaresGridPage> {
      ...
      child: Scaffold(
        ...
        body: Center(
          child: Wrap(
            ...
            children: generateComplexSquares(25000),
          ),
        ),
      ),
    );
